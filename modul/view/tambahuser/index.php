                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="<?= BASEURL; ?>tambahuser/tambah" method="POST">
                                        <div class="form-group">
                                            <input type="text" name="nama" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Nama..." required>
                                        </div>
                                        <div class="form-group">
